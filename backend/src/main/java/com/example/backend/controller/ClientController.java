...
public class ClientController {
	...
	public ResponseEntity<Client> setDataClient(@PathVariable Long id,  DataClient dataR) {
		Client client = clientRepository.findById(id).
				orElseThrow(() -> new ResourceNotFoundException("Client not exist with id :" + id));;
		 dataR.setClient(client);
		 Client setDataClient=dataClientRepository.save(dataR);
